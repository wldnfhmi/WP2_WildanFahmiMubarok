...
class Buku extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $this->form_validation->set_rules('pengaranag', 'Nama Pengarang', 'required|min_length[3]', [
      'required' => 'Nama pengarang harus diisi',
      'min_length' => 'Nama pengarang teralu pendel'
    ]);
  ...
  public function kategori()
  {
    ...
    $this->form_valdation->set_rules('kategori', 'Kategori', 'required', [
      'required' => 'Judul Buku Harus diisi'
    ]);
